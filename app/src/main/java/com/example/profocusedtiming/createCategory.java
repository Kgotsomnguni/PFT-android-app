...
public class createCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Cancel.setOnClickListener(view -> startActivity(new Intent(createCategory.this, HomeActivity.class)));
    ...
    private void saveChanges() {
        myRef.child(categoryId).setValue(category);
        Toast.makeText(this, "categories modified", Toast.LENGTH_SHORT).show();
